...
--add-data "venv\Lib\site-packages\ivm\ivm-win%target_platform%\ivm.dll;ivm\ivm-win%target_platform%" ^
...
rename dist release
rename release\main.exe eplab.exe
xcopy resources\win%target_platform%\drivers\* release\drivers\* /S /E
