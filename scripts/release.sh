...
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/doc/p10_elements.schema.json:epcore/doc" \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/doc/p10_elements_2.schema.json:epcore/doc" \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/doc/ufiv.schema.json:epcore/doc" \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/ASA_device_settings.json:epcore/ivmeasurer" \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/asa10/libasa-debian/libasa.so:." \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/asa10/libasa-debian/libxmlrpc.so.3.51:." \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/asa10/libasa-debian/libxmlrpc_client.so.3.51:." \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/asa10/libasa-debian/libxmlrpc_util.so.4.51:." \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/asa10/libasa-debian/libxmlrpc_xmlparse.so.3.51:." \
...
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/ivm02/ivm-debian/libivm.so:epcore/ivmeasurer/ivm02/ivm-debian" \
--add-data "./venv/lib/python${PYTHON_VERSION}/site-packages/epcore/ivmeasurer/ivm10/ivm-debian/libivm.so:epcore/ivmeasurer/ivm10/ivm-debian" \
