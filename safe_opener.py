...
import logging
import os
from urpcbase import UrpcbaseDeviceHandle

logger = logging.getLogger("eplab")


def _log_runtime(message: str, error: bool = True, warning: bool = False):
    """
...
def open_device_safely(device: UrpcbaseDeviceHandle, config_file: str):
    """
