...
class SettingsWindow(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.score_threshold_button_minus.clicked.connect(parent._on_threshold_dec)
        self.score_threshold_button_plus.clicked.connect(parent._on_threshold_inc)
        validator = QRegExpValidator(QRegExp(r"^(\d|\d\d|100)%?"), self)
        self.score_threshold_value_lineEdit.setValidator(validator)
