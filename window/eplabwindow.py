...
class EPLabWindow(QMainWindow):
    ...
    def _change_work_mode(self, mode: WorkMode) -> None:
        ...
        self.start_plan_measurement_action.setEnabled(enable)
    ...
    def _init_ui(self) -> None:
        ...
        self.start_plan_measurement_action.triggered.connect(self._mux_and_plan_window.start_plan_measurement)
    ...
    def create_report(self, auto_detection_report_path: bool = False) -> None:
        ...
        if dir_path:
            show_report_generation_window(self, self._report_generation_thread, self.measurement_plan,
                                          self._measurement_plan_path.get_measurement_plan_name_without_extension(),
                                          dir_path, self.tolerance, self.work_mode)
    ...
    def enable_widgets(self, enabled: bool) -> None:
        ...
        widgets = (self.new_file_action, self.save_file_action, self.save_as_file_action,
                   ...
                   self.start_plan_measurement_action, self.comment_dock, self.score_dock,
