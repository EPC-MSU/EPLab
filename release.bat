...
--add-data "venv\Lib\site-packages\epcore\analogmultiplexer\epmux\epmux-win32\epmux.dll;." ^
...
--add-data "venv\Lib\site-packages\epcore\ivmeasurer\ivm02\ivm-win32\ivm.dll;epcore\ivmeasurer\ivm02\ivm-win32" ^
--add-data "venv\Lib\site-packages\epcore\ivmeasurer\ivm10\ivm-win32\ivm.dll;epcore\ivmeasurer\ivm10\ivm-win32" ^
...
--add-data "venv\Lib\site-packages\epcore\analogmultiplexer\epmux\epmux-win64\epmux.dll;." ^
--add-data "venv\Lib\site-packages\epcore\ivmeasurer\ASA_device_settings.json;epcore\ivmeasurer" ^
--add-data "venv\Lib\site-packages\epcore\ivmeasurer\EyePoint_settings.json;epcore\ivmeasurer" ^
--add-data "venv\Lib\site-packages\epcore\ivmeasurer\EyePoint_virtual_device_settings.json;epcore\ivmeasurer" ^
--add-data "venv\Lib\site-packages\epcore\ivmeasurer\ivm02\ivm-win64\ivm.dll;epcore\ivmeasurer\ivm02\ivm-win64" ^
--add-data "venv\Lib\site-packages\epcore\ivmeasurer\ivm10\ivm-win64\ivm.dll;epcore\ivmeasurer\ivm10\ivm-win64" ^
--add-data "venv\Lib\site-packages\epcore\doc\p10_elements.schema.json;epcore\doc" ^
--add-data "venv\Lib\site-packages\epcore\doc\p10_elements_2.schema.json;epcore\doc" ^
--add-data "venv\Lib\site-packages\epcore\doc\ufiv.schema.json;epcore\doc" ^
