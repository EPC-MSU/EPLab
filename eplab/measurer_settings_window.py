...
class MeasurerSettingsWindow(qt.QDialog):
    ...
    def run_command(self, command_to_run: Callable, command_name: str, user_readable_command_name: str):
        ...
        try:
            ...
            logging.error("Failed to execute command %s for measurer %s", command_name, self._measurer.name)
    ...
    def set_parameters(self):
        ...
        try:
            ...
            logging.error("Failed to set settings in measurer %s", self._measurer.name)
