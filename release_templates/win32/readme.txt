...
Для запуска работы с устройством ASA пропишите в скрипте start_asa.bat вместо xmlrpc:172.16.128.137 IP адрес запущенного
сервера ASA и запустите скрипт.
...
Для запуска работы с устройством ASA пропишите в скрипте start_asa.sh вместо xmlrpc:172.16.128.137 IP адрес запущенного
сервера ASA и запустите скрипт.